...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Honey Chain — Verified honey traceability" },
      {
        name: "description",
        content:
          "Blockchain-backed honey traceability and smart beekeeping management with virtual IoT hive monitoring and AI-assisted colony health analysis.",
      },
